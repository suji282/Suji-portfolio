...
<body>
    ...
    <header>
        ...
        <img src="/storage/emulated/0/Android/media/com.whatsapp/WhatsApp/Media/WhatsApp Images/IMG-20240514-WA0033.jpg" alt="Suji B" class="profile-picture">
    ...
    <section id="resume">
        <div class="section-content" style="text-align: center;">
            ...
            <a href="/storage/emulated/0/Download/dorabot.io_images-to-pdf (1).pdf" class="download-button">Download CV</a>
        </div>
    </section>
    ...
    <section id="contact">
        <div class="section-content">
            <h2>Contact Me</h2>
            <p>Email: <a href="mailto:Suji B">cs2301111058251@lngovernmentcollege.com</a></p>
        </div>
    </section>

    <footer>
        <p>&copy; 2025 Suji B. All Rights Reserved.</p>
    </footer>

</body>
</html>
The any error on the code
